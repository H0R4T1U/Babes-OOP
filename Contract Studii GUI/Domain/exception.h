...
public:
	...
	InvalidDisciplinaError(const string &errorMessage) : Error(errorMessage) {};
};
...
public:
	...
	InexistentDisciplinaError(const string& errorMessage) : Error(errorMessage) {};
};
...
public:
	...
	ExistentDisciplinaError(const string& errorMessage) : Error(errorMessage) {};
};
...
public:
	...
	EmptyListError(const string& errorMessage) : Error(errorMessage) {};
};
...
public:
	...
	InvalidSortingMode(const string& errorMessage) : Error(errorMessage) {};
};
...
public:
	...
	InvalidDenumire(const string& errorMessage) : Error(errorMessage) {};
};
...
public:
	...
	InvalidGenerateNumber(const string& errorMessage) : Error(errorMessage) {};
};
...
public:
	...
	InvalidFileError(const string& errorMessage) : Error(errorMessage) {};
};